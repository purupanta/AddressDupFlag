...
DROP TABLE IF EXISTS [SalesforceStaging].[dbo].[ADT2_AddressesInvolvedInDupsFinal];
GO

CREATE TABLE dbo.ADT2_AddressesInvolvedInDupsFinal
	(
	Id int NOT NULL,
	ADT0_Id int NOT NULL,
	ADT1_Id int NOT NULL,
	BatchId int NULL,
	Name nvarchar(100) NULL,
	DupCount nvarchar(50) NULL,
	DupAddressIds nvarchar(1000) NULL,
	DupFlag nvarchar(50) NULL,
...
GO
ALTER TABLE dbo.ADT2_AddressesInvolvedInDupsFinal SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
