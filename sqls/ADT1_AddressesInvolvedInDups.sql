...
DROP TABLE IF EXISTS [SalesforceStaging].[dbo].[ADT1_AddressesInvolvedInDups];
GO

CREATE TABLE dbo.ADT1_AddressesInvolvedInDups
	(
	Id int NOT NULL,
...
GO
ALTER TABLE dbo.ADT1_AddressesInvolvedInDups SET (LOCK_ESCALATION = TABLE)
GO
COMMIT
